...
function [Imagen  Total_Num_Error  Out_Of_Errors  BER  Average_Phase_Error Percent_of_Error]...
         = OFDM_FUNCTION(FileNameImage_Input, Fft_Size, NumCarriers, Amplitude_Clipping, Modulation, SNR,handles )
% *************** MAIN PROGRAM FILE *************** %
